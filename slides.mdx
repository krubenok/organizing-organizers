...
import { Notes, Image, Head, Split, Appear, Invert } from 'mdx-deck'
import sponsorship from './images/sponsorship-home.png'
import agreement from './images/mchacks-6-agreement.png'
