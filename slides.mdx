...
import { Notes, Image, Head, Split, Appear } from 'mdx-deck'
...
Let's focus in on a key word from that definition. *Planning*.
...
[![A Timeline of tasks leading up to the event related to sponsorship](images/timeline.png)](https://notion.so)
...
In a group, create a timeline and dependancy tree for an aspect of a hackathon. 

<Split>

- What information do you need to collect?
- How is it shared and acted on?
