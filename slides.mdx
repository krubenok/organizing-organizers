...
import { Notes, Image, Head } from 'mdx-deck'
...
<Notes>
    ...
    Some ideas, design requests, hacker acceptances, incoming questions/emails/facebook messages, vendor quotes, meeting minutes. 
</Notes>
